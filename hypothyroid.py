...
Original file is located at
    https://colab.research.google.com/drive/1i6vdM8zPM75vB-oDqoZS082lNVuUV7VT
"""
...
df = df.drop(columns = ['on_thyroxine','query_on_thyroxine','on_antithyroid_medication','thyroid_surgery','query_hypothyroid','query_hyperthyroid','sick','lithium'])
df.head(2)
...
columns = ['Age','Sex','pregnant','tumor','goitre','TSH_measured','TSH','T3_measured','T3','TT4_measured','TT4','T4U_measured','T4U','FTI_measured','FTI','TBG_measured','TBG']
x = df[columns]
y=df["class"]
...
import lightgbm as ltb
model = ltb.LGBMClassifier(boosting_type='dart', max_depth=10, num_leaves=90, learning_rate=0.199,
                           objective='binary', tree_learner='data', metric='binary_logloss', n_estimators=100)
...
print("Accuracy:  ",metrics.accuracy_score(expected_y, y_pred)*100)
